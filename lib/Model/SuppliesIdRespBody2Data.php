 ...
 */
class SuppliesIdRespBody2Data implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'suppliesIdRespBody2_data';
    ...
    */
     ...
     * Sets failed_orders
     *
     * @param string[]|null $failed_orders Список заказов, которые не удалось обработать.
     *
     * @return self
     */
