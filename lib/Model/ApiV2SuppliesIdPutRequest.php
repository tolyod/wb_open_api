...
/**
 * ApiV2SuppliesIdPutRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV2SuppliesIdPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v2_supplies__id__put_request';
    ...
    */
     ...
     * Sets orders
     *
     * @param string[]|null $orders Список заказов.
     *
     * @return self
     */
