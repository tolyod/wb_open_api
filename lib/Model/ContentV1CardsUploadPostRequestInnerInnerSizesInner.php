...
/**
 * ContentV1CardsUploadPostRequestInnerInnerSizesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentV1CardsUploadPostRequestInnerInnerSizesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_content_v1_cards_upload_post_request_inner_inner_sizes_inner';
    ...
    */
     ...
     * Sets tech_size
     *
     * @param string|null $tech_size Размер поставщика (пример S, M, L, XL, 42, 42-43)
     *
     * @return self
     */
     ...
     * Sets wb_size
     *
     * @param string|null $wb_size Рос. размер
     *
     * @return self
     */
     ...
     * Sets skus
     *
     * @param string[]|null $skus Массив баркодов, строковых идентификаторов размеров поставщика (их можно сгенерировать с помощью API, см. Viewer)
     *
     * @return self
     */
