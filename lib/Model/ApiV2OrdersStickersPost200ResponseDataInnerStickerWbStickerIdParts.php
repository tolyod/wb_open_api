...
/**
 * ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v2_orders_stickers_post_200_response_data_inner_sticker_wbStickerIdParts';
    ...
    */
     ...
     * Sets a
     *
     * @param string|null $a Первая часть идентификатора этикетки (для печати подписи).
     *
     * @return self
     */
     ...
     * Sets b
     *
     * @param string|null $b Вторая часть идентификатора этикетки.
     *
     * @return self
     */
