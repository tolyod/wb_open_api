...
/**
 * ApiV2StocksDelete200Response2DataInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV2StocksDelete200Response2DataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v2_stocks_delete_200_response_2_data_inner';
    ...
    */
     ...
     * Sets err
     *
     * @param string|null $err Причина по которой нельзя удалить данный остаток.
     *
     * @return self
     */
