...
/**
 * ApiV2OrdersGet200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV2OrdersGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v2_orders_get_200_response';
    ...
    protected static $openAPITypes = [
        'total' => 'int',
        'orders' => '\OpenAPI\Client\Model\ApiV2OrdersGet200ResponseOrdersInner[]'
    ];
    ...
    */
     ...
     * Sets total
     *
     * @param int|null $total Общее количество заказов по заданным параметрам (за указанный промежуток времени).
     *
     * @return self
     */
     ...
     * Gets orders
     *
     * @return \OpenAPI\Client\Model\ApiV2OrdersGet200ResponseOrdersInner[]|null
     */
     ...
     * Sets orders
     *
     * @param \OpenAPI\Client\Model\ApiV2OrdersGet200ResponseOrdersInner[]|null $orders Список заказов.
     *
     * @return self
     */
