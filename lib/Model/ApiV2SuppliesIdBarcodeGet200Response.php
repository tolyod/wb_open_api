...
/**
 * ApiV2SuppliesIdBarcodeGet200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV2SuppliesIdBarcodeGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v2_supplies__id__barcode_get_200_response';
    ...
    */
     ...
     * Sets mime_type
     *
     * @param string|null $mime_type Формат передаваемого файла.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Идентификатор поставки
     *
     * @return self
     */
     ...
     * Sets file
     *
     * @param string|null $file Штрихкод поставки генерируется в формате code-128. Сам файл приходит в массиве байтов, закодированном в base64.
     *
     * @return self
     */
