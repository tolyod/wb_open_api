...
/**
 * ApiV2SuppliesGet200ResponseSuppliesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV2SuppliesGet200ResponseSuppliesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v2_supplies_get_200_response_supplies_inner';
    ...
    */
     ...
     * Sets supply_id
     *
     * @param string|null $supply_id Идентификатор поставки
     *
     * @return self
     */
