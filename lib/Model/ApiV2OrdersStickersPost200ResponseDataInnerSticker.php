...
/**
 * ApiV2OrdersStickersPost200ResponseDataInnerSticker Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV2OrdersStickersPost200ResponseDataInnerSticker implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v2_orders_stickers_post_200_response_data_inner_sticker';
    ...
    protected static $openAPITypes = [
        'wb_sticker_id' => 'int',
        'wb_sticker_id_parts' => '\OpenAPI\Client\Model\ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts',
    ...
    protected static array $openAPINullables = [
        'wb_sticker_id' => false,
		'wb_sticker_id_parts' => false,
		'wb_sticker_encoded' => false,
		'wb_sticker_svg_base64' => false,
		'wb_sticker_zpl_v' => false,
		'wb_sticker_zpl' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('wb_sticker_id_parts', $data ?? [], null);
        $this->setIfExists('wb_sticker_encoded', $data ?? [], null);
        $this->setIfExists('wb_sticker_svg_base64', $data ?? [], null);
        $this->setIfExists('wb_sticker_zpl_v', $data ?? [], null);
        $this->setIfExists('wb_sticker_zpl', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets wb_sticker_id
     *
     * @param int|null $wb_sticker_id Идентификатор этикетки.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts|null $wb_sticker_id_parts wb_sticker_id_parts
     *
     * @return self
     */
    public function setWbStickerIdParts($wb_sticker_id_parts)
    {
        ...
        if (is_null($wb_sticker_id_parts)) {
            throw new \InvalidArgumentException('non-nullable wb_sticker_id_parts cannot be null');
        }
     ...
     *
     * @param string|null $wb_sticker_encoded Закодированное значение стикера (представляется на этикетке в формате Code-128).
     *
     * @return self
     */
    public function setWbStickerEncoded($wb_sticker_encoded)
    {
        ...
        if (is_null($wb_sticker_encoded)) {
            throw new \InvalidArgumentException('non-nullable wb_sticker_encoded cannot be null');
        }
     ...
     *
     * @param string|null $wb_sticker_svg_base64 Полное представление этикетки в векторном формате.
     *
     * @return self
     */
    public function setWbStickerSvgBase64($wb_sticker_svg_base64)
    {
        ...
        if (is_null($wb_sticker_svg_base64)) {
            throw new \InvalidArgumentException('non-nullable wb_sticker_svg_base64 cannot be null');
        }
     ...
     *
     * @param string|null $wb_sticker_zpl_v Полное представление этикетки в формате ZPL (вертикальное положение).
     *
     * @return self
     */
    public function setWbStickerZplV($wb_sticker_zpl_v)
    {
        ...
        if (is_null($wb_sticker_zpl_v)) {
            throw new \InvalidArgumentException('non-nullable wb_sticker_zpl_v cannot be null');
        }
     ...
     * Sets wb_sticker_zpl
     *
     * @param string|null $wb_sticker_zpl Полное представление этикетки в формате ZPL (горизонтальное положение)
     *
     * @return self
     */
    public function setWbStickerZpl($wb_sticker_zpl)
    {
        ...
        if (is_null($wb_sticker_zpl)) {
            throw new \InvalidArgumentException('non-nullable wb_sticker_zpl cannot be null');
        }
