...
class ContentV1CardsUpdatePostRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets nm_id
     *
     * @param int|null $nm_id Числовой идентификатор номенклатуры Wildberries
     *
     * @return self
     */
     ...
     * Sets vendor_code
     *
     * @param string|null $vendor_code Вендор код, текстовый идентификатор номенклатуры поставщика
     *
     * @return self
     */
     ...
     * Gets sizes
     *
     * @return \OpenAPI\Client\Model\ContentV1CardsUpdatePostRequestInnerSizesInner[]|null
     */
     ...
     * Sets sizes
     *
     * @param \OpenAPI\Client\Model\ContentV1CardsUpdatePostRequestInnerSizesInner[]|null $sizes Массив размеров для номенклатуры (для безразмерного товара все равно нужно передавать данный массив с одним элементом и нулевым размером, но с ценой и баркодом)
     *
     * @return self
     */
