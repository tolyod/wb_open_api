...
/**
 * ApiV2StocksDelete200Response1DataErrorInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV2StocksDelete200Response1DataErrorInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v2_stocks_delete_200_response_1_data_error_inner';
    ...
    */
     ...
     * Sets err
     *
     * @param string|null $err Ошибка, случившаяся при загрудке остатка с данным баркодом.
     *
     * @return self
     */
