...
/**
 * ApiV2OrdersGet200ResponseOrdersInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV2OrdersGet200ResponseOrdersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v2_orders_get_200_response_orders_inner';
    ...
    protected static $openAPITypes = [
        ...
        'delivery_address_details' => '\OpenAPI\Client\Model\DeliveryAddressDetails',
        'user_info' => '\OpenAPI\Client\Model\UserInfo',
        'chrt_id' => 'int',
        'barcode' => 'string',
        'barcodes' => 'string[]',
    ...
    protected static array $openAPINullables = [
		...
		'office_latitude' => false,
		'office_longitude' => false,
		'delivery_address' => false,
		'delivery_address_details' => false,
		'user_info' => false,
		'chrt_id' => false,
		'barcode' => false,
		'barcodes' => false,
		'sc_offices_names' => false,
		'status' => false,
		'user_status' => false,
		'rid' => false,
		'total_price' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('office_latitude', $data ?? [], null);
        $this->setIfExists('office_longitude', $data ?? [], null);
        $this->setIfExists('delivery_address', $data ?? [], null);
        $this->setIfExists('delivery_address_details', $data ?? [], null);
        ...
        $this->setIfExists('sc_offices_names', $data ?? [], null);
    ...
    */
     ...
     *
     * @param float|null $office_latitude Широта адреса ПВЗ/магазина, куда необходимо доставить заказ (если применимо).
     *
     * @return self
     */
    public function setOfficeLatitude($office_latitude)
    {
        ...
        if (is_null($office_latitude)) {
            throw new \InvalidArgumentException('non-nullable office_latitude cannot be null');
        }
     ...
     *
     * @param float|null $office_longitude Долгота адреса ПВЗ/магазина, куда необходимо доставить заказ (если применимо).
     *
     * @return self
     */
    public function setOfficeLongitude($office_longitude)
    {
        ...
        if (is_null($office_longitude)) {
            throw new \InvalidArgumentException('non-nullable office_longitude cannot be null');
        }
     ...
     *
     * @param string|null $delivery_address Адрес клиента для доставки.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\DeliveryAddressDetails|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\DeliveryAddressDetails|null $delivery_address_details delivery_address_details
     *
     * @return self
     */
    public function setDeliveryAddressDetails($delivery_address_details)
    {
        ...
        if (is_null($delivery_address_details)) {
            throw new \InvalidArgumentException('non-nullable delivery_address_details cannot be null');
        }
     ...
     * Gets user_info
     *
     * @return \OpenAPI\Client\Model\UserInfo|null
     */
     ...
     * Sets user_info
     *
     * @param \OpenAPI\Client\Model\UserInfo|null $user_info user_info
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $sc_offices_names Массив СЦ приоритетных для доставки заказа. <br>Если поле не заполнено или массив пустой, приоритетного СЦ нет для данного заказа нет.
     *
     * @return self
     */
    public function setScOfficesNames($sc_offices_names)
    {
        ...
        if (is_null($sc_offices_names)) {
            throw new \InvalidArgumentException('non-nullable sc_offices_names cannot be null');
        }
