...
/**
 * ContentV1CardsUploadPostRequestInnerInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentV1CardsUploadPostRequestInnerInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_content_v1_cards_upload_post_request_inner_inner';
    ...
    protected static $openAPITypes = [
        ...
        'sizes' => '\OpenAPI\Client\Model\ContentV1CardsUploadPostRequestInnerInnerSizesInner[]'
    ];
    ...
    */
     ...
     * Sets vendor_code
     *
     * @param string|null $vendor_code Артикул новой НМ которую хотим создать в КТ
     *
     * @return self
     */
     ...
     * Gets sizes
     *
     * @return \OpenAPI\Client\Model\ContentV1CardsUploadPostRequestInnerInnerSizesInner[]|null
     */
     ...
     * Sets sizes
     *
     * @param \OpenAPI\Client\Model\ContentV1CardsUploadPostRequestInnerInnerSizesInner[]|null $sizes Массив размеров для номенклатуры (для безразмерного товара все равно нужно передавать данный массив с одним элементом и пустым Рос. размером, но с ценой и баркодом)
     *
     * @return self
     */
