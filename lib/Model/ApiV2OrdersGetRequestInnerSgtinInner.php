...
/**
 * ApiV2OrdersGetRequestInnerSgtinInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV2OrdersGetRequestInnerSgtinInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v2_orders_get_request_inner_sgtin_inner';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code Код маркировки на упаковке.
     *
     * @return self
     */
     ...
     * Sets numerator
     *
     * @param int|null $numerator Числитель, количество единиц товара из упаковки (1, если продается целая упаковка).
     *
     * @return self
     */
     ...
     * Sets denominator
     *
     * @param int|null $denominator Знаменатель, количество единиц товара в упаковке (1, если продается целая упаковка, т.е. для полной упаковки числитель = знаменатель = 1)
     *
     * @return self
     */
     ...
     * Sets sid
     *
     * @param int|null $sid Идентификатор места деятельности субъекта обращения в ИС МДЛП.
     *
     * @return self
     */
