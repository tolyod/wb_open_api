...
/**
 * ApiV2OrdersGetRequestInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV2OrdersGetRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v2_orders_get_request_inner';
    ...
    protected static $openAPITypes = [
        'order_id' => 'string',
        'status' => 'int',
        'sgtin' => '\OpenAPI\Client\Model\ApiV2OrdersGetRequestInnerSgtinInner[]'
    ];
    ...
    */
     ...
     * Gets sgtin
     *
     * @return \OpenAPI\Client\Model\ApiV2OrdersGetRequestInnerSgtinInner[]|null
     */
     ...
     * Sets sgtin
     *
     * @param \OpenAPI\Client\Model\ApiV2OrdersGetRequestInnerSgtinInner[]|null $sgtin Массив КИЗов. Требуется только для фармацевтической продукции при переводе её в статус `6` (\"Клиент получил товар\").
     *
     * @return self
     */
