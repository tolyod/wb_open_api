...
/**
 * ContentV1DirectoryCollectionsGet200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentV1DirectoryCollectionsGet200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_content_v1_directory_collections_get_200_response_data_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Идентификатор значения характеристики
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Значение характеристики
     *
     * @return self
     */
